...
import {
  ...
  useStaffTransaction, useStaffHistory, useUpdateStaff, useDeleteStaff,
...
export default function Staff() {
  ...
  const { data: history } = useStaffHistory(historyStaff?.id ?? undefined);
        ...
        <Dialog open={historyOpen} onOpenChange={setHistoryOpen}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>Complete payment and adjustment history.</DialogDescription>
            </DialogHeader>
